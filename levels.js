const circuits=[
  ...
  {
    id:'cryoline',number:'03',name:'CRYOLINE ZERO',mark:'氷 / 零度',theme:'BOREAL TERMINAL // WHITEOUT',tagline:'Black ice. Aurora sky. Zero margin.',promise:'Stay cold. Cut clean.',mission:'Carve the glacier switchbacks, cross the fractured ice port, and race the launch crawler beneath a living aurora.',brief:'Master the frozen edge.',briefBody:'The technical circuit. Low grip extends every slide, barriers close in through the ice vault, and the final launch yard demands a clean exit.',accent:'#8de8ff',accent2:'#a983ff',sky:0x07172b,fog:0x244d65,ground:0xb8d9df,road:0x263b50,edgeA:0xa983ff,edgeB:0x8de8ff,grip:.72,topSpeed:63,pace:.96,record:'neon-cryoline',
